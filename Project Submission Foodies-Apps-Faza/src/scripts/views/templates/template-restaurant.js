...
<div class="detail">
    <div class="restaurant-item-detail">
        ...
        <img class="lazyload restaurant-item-thumbnail-detail" data-src="${CONFIG.BASE_IMAGE_URL + restaurant.pictureId}" alt="${restaurant.name}"/>
    </div>
    <div class="restaurant-info">
        ...
        <h3 class="restaurant-text"> ★ ${restaurant.rating}</h3>
...
<div class="restaurant-item">
    <img class=" lazyload restaurant-item-thumbnail"
        data-src="${CONFIG.BASE_IMAGE_URL + restaurant.pictureId}"
        alt="${restaurant.name}">
    <div class="restaurant-item-location">${restaurant.city}</div>
    <div class="restaurant-item-content">
        <p class="restaurant-item-rating">Rating : <p class="restaurant-item-rating-star"> ★ ${restaurant.rating}</p>
        </p>
        ...
        onClick="window.location.href='${`/#/detail/${restaurant.id}`}'"><p>Read More</p></button>
    </div>
    </div>
`;
